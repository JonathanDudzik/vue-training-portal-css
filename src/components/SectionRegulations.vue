...
export default {
  ...
  mounted() {
    ...
    this.$store.commit('changeNextRoute', this.$router.options.routes[3].children[3].name)
    this.$store.commit('changePrevRoute', this.$router.options.routes[3].children[1].name)
  },
}
</script>
